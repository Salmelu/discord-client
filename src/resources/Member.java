...
public interface Member {
     ...
     * <p>This method issues a request to Discord server and it blocks until the request is completed.</p>
     ...
     * @throws PermissionDeniedException if the application doesn't have manage roles permission
     */
    void setRoles(List<Role> roles) throws PermissionDeniedException;
     ...
     */
    void mute(boolean mute) throws PermissionDeniedException;
     ...
     */
    void deafen(boolean deaf) throws PermissionDeniedException;
     ...
     */
    void moveChannel(ServerChannel newChannel) throws PermissionDeniedException, IllegalArgumentException;
     ...
     */
    void ban(int messageDays) throws PermissionDeniedException;
     ...
     */
    void kick() throws PermissionDeniedException;
     ...
     */
    void changeNickname(String nickname) throws PermissionDeniedException;
}
